...
resource "aws_db_parameter_group" "mysql_standalone_parametergroup" {
  name   = "${var.project}-${var.environment}-mysql-standalone-prametergroup"
  family = "mysql8.0"
...
# RDS subent group
# ------------------------------
resource "aws_db_subnet_group" "mysql_mysql_standalone_subnetgroup" {
...
resource "aws_db_instance" "mysql_standalone" {
  ...
  db_subnet_group_name   = aws_db_subnet_group.mysql_mysql_standalone_subnetgroup.name
